  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center text-center p-5">
        <div data-aos="zoom-in-right" data-aos-once className="md:w-3/5 sm:p-5 text-gray-700">
        ...
        <div className="md:w-2/5">
          <div className="overflow-hidden">
            <img data-aos="flip-up" data-aos-once className="w-full" src={riadPic} alt="Sadman ryan Riad pic" />
          </div>
        </div>
      </div>
    </div>
