  ...
  return (
    <div className="dark:bg-gray-700 p-5 text-center flex-1">
      <div className="flex flex-col-reverse gap-5 items-center justify-center p-5">
        <div data-aos="fade-right" data-aos-once data-aos-duration="800" className="mx-5">
          <a
        ...
        <div data-aos="fade-right" data-aos-once data-aos-duration="1000" className="mx-5">
          <a
        ...
        <div data-aos="fade-right" data-aos-once data-aos-duration="1200" className="mx-5">
          <a
        ...
        <div data-aos="fade-right" data-aos-once data-aos-duration="1400" className="mx-5">
          <a
